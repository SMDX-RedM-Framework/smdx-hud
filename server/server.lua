...
SMDXCore.Commands.Add('cash', 'Check Cash Balance', {}, false, function(source, args)
...
SMDXCore.Commands.Add('bloodmoney', 'Check Bloodmoney Balance', {}, false, function(source, args)
    local Player = SMDXCore.Functions.GetPlayer(source)
...
SMDXCore.Functions.CreateCallback('hud:server:getTelegramsAmount', function(source, cb)
    local src = source
    local Player = SMDXCore.Functions.GetPlayer(src)
    if Player ~= nil then
